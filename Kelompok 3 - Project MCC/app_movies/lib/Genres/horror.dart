...
class HorrorMoviesWidget extends StatefulWidget {
  final Future<List<Tape>> tapeList;
  final bool showSpeedDial;

  const HorrorMoviesWidget(
      {super.key, required this.tapeList, this.showSpeedDial = false});

  @override
  State<HorrorMoviesWidget> createState() => _HorrorMoviesWidgetState();
}

class _HorrorMoviesWidgetState extends State<HorrorMoviesWidget> {
  int _currentIndex = 0;
