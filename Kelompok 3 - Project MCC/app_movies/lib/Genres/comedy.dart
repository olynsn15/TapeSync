...
class ComedyMoviesWidget extends StatefulWidget {
  final Future<List<Tape>> tapeList;
  final bool showSpeedDial;

  const ComedyMoviesWidget(
      {super.key, required this.tapeList, this.showSpeedDial = false});

  @override
  State<ComedyMoviesWidget> createState() => _ComedyMoviesWidgetState();
}

class _ComedyMoviesWidgetState extends State<ComedyMoviesWidget> {
  int _currentIndex = 0;
