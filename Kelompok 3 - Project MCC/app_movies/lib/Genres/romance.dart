...
class RomanceMoviesWidget extends StatefulWidget {
  final Future<List<Tape>> tapeList;
  final bool showSpeedDial;

  const RomanceMoviesWidget(
      {super.key, required this.tapeList, this.showSpeedDial = false});

  @override
  State<RomanceMoviesWidget> createState() => _RomanceMoviesWidgetState();
}

class _RomanceMoviesWidgetState extends State<RomanceMoviesWidget> {
  int _currentIndex = 0;
